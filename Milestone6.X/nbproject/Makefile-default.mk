...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/LineFollowingMasterPic.o: LineFollowingMasterPic.c  .generated_files/flags/default/fbc46d7ec7338635dd753c532540b3c7c111cb89 .generated_files/flags/default/7dab310884e5de58b737751714b62c5515706f0f
	@${MKDIR} "${OBJECTDIR}" 
...
${OBJECTDIR}/LineFollowingMasterPic.o: LineFollowingMasterPic.c  .generated_files/flags/default/82abecd7675b0735f76d3d8e80ab425e561118d7 .generated_files/flags/default/7dab310884e5de58b737751714b62c5515706f0f
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/LineFollowingMasterPic.o.d 
	@${RM} ${OBJECTDIR}/LineFollowingMasterPic.o 
...
${DISTDIR}/Milestone6.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	${MP_CC_DIR}\\xc16-bin2hex ${DISTDIR}/Milestone6.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -a  -omf=elf   
