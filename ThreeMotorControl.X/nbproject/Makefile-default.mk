...
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/MasterPic.o
POSSIBLE_DEPFILES=${OBJECTDIR}/MasterPic.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/MasterPic.o
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/MasterPic.o: MasterPic.c  .generated_files/flags/default/41cbf7a7d0d9c01c42579b92da6769c9d1f8b .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/MasterPic.o.d 
	@${RM} ${OBJECTDIR}/MasterPic.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  MasterPic.c  -o ${OBJECTDIR}/MasterPic.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MP -MMD -MF "${OBJECTDIR}/MasterPic.o.d"      -g -D__DEBUG     -omf=elf -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off    -mdfp="${DFP_DIR}/xc16"
	
else
${OBJECTDIR}/MasterPic.o: MasterPic.c  .generated_files/flags/default/d51d7b2834ca05f1b5ff007077a3c2c45c5e9091 .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/MasterPic.o.d 
	@${RM} ${OBJECTDIR}/MasterPic.o 
